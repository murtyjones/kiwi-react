...
export default ACTIONS = {
  ...
  , OPEN_TOP_BAR: 'OPEN_TOP_BAR'
  , CLOSE_TOP_BAR: 'CLOSE_TOP_BAR'
  , SET_TOP_BAR_TITLE: 'SET_TOP_BAR_TITLE'
  , TOGGLE_TOP_BAR_TITLE_EDITABLE: 'TOGGLE_TOP_BAR_TITLE_EDITABLE'
  , TOGGLE_TOP_BAR_TITLE_FOCUS: 'TOGGLE_TOP_BAR_TITLE_FOCUS'
  , SET_TOP_BAR_COLOR: 'SET_TOP_BAR_COLOR'
  , SET_TOP_BAR_BREADCRUMB: 'SET_TOP_BAR_BREADCRUMB'
  , SET_TOP_BAR_MIDDLE_IS_VISIBLE: 'SET_TOP_BAR_MIDDLE_IS_VISIBLE'
  , SET_TOP_BAR_LOGO_IS_VISIBLE: 'SET_TOP_BAR_LOGO_IS_VISIBLE'
  ...
  , CLEAR_TEMPORARY_PASSWORD: 'CLEAR_TEMPORARY_PASSWORD'
